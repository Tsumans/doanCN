          ...
          <div class="col-md-9 single-main-left">
            <div class="sngl-top">
              ...
              <div class="col-md-7 single-top-right">
                <div class="single-para simpleCart_shelfItem">
                  ...
                  <ul class="tag-men">
                    <li>
                      <span>TAG</span> <span class="women1">: Women,</span>
                    </li>
            ...
            <div class="tabs">
              <ul class="menu_drop">
                  ...
                  <ul>
                    ...
                    <li class="subitem2">
                      <a href="#">
                        ...
                        luptatum zzril delenit augue duis dolore</a
                      >
                    </li>
                    <li class="subitem3">
                      <a href="#"
                ...
                <li class="item2">
                  <a href="#"
                    ><img src="images/arrow.png" alt="" />Additional
                    information</a
                  >
                  <ul>
                    <li class="subitem2">
                ...
                <li class="item4">
                  <a href="#"
                    ><img src="images/arrow.png" alt="" />Helpful Links</a
                  >
                  <ul>
                    <li class="subitem2">
                      <a href="#">
                ...
                <li class="item5">
                  <a href="#"
                    ><img src="images/arrow.png" alt="" />Make A Gift</a
                  >
                  <ul>
                    <li class="subitem1">
                      <a href="#"
            ...
            <div class="w_sidebar">
                  ...
                  <div class="col col-4">
                    <label class="checkbox"
                      ><input
                        ...
                        name="checkbox"
                        checked=""
                      /><i></i>All Accessories</label
                    >
                  </div>
                  <div class="col col-4">
                    <label class="checkbox"
                      ><input type="checkbox" name="checkbox" /><i></i>Women
                      Watches</label
                    >
                    <label class="checkbox"
                      ><input type="checkbox" name="checkbox" /><i></i>Kids
                      Watches</label
                    >
                    <label class="checkbox"
                      ><input type="checkbox" name="checkbox" /><i></i>Men
                      Watches</label
                    >
                  </div>
                </div>
              ...
              <section class="sky-form">
                ...
                <div class="row1 row2 scroll-pane">
                  <div class="col col-4">
                    <label class="radio"
                      ><input type="radio" name="radio" checked="" /><i></i>60 %
                      and above</label
                    >
                    <label class="radio"
                      ><input type="radio" name="radio" /><i></i>50 % and
                      above</label
                    >
                    <label class="radio"
                      ><input type="radio" name="radio" /><i></i>40 % and
                      above</label
                    >
                  </div>
                  <div class="col col-4">
                    <label class="radio"
                      ><input type="radio" name="radio" /><i></i>30 % and
                      above</label
                    >
                    <label class="radio"
                      ><input type="radio" name="radio" /><i></i>20 % and
                      above</label
                    >
                    <label class="radio"
                      ><input type="radio" name="radio" /><i></i>10 % and
                      above</label
                    >
                  </div>
                </div>
