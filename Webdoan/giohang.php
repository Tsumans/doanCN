...
<html>
  <head>
    <title>
      Luxury Watches A Ecommerce Category Flat Bootstarp Resposive Website
      Template | Checkout :: w3layouts
    </title>
          ...
          <div class="cart-items">
            ...
            <div class="in-check">
              ...
              <ul class="cart-header">
                ...
                <li class="ring-in">
                  <a href="single.php"
                    ><img src="images/c-1.jpg" class="img-responsive" alt=""
                  /></a>
                </li>
              ...
              <ul class="cart-header1">
                ...
                <li class="ring-in">
                  <a href="single.php"
                    ><img src="images/c-2.jpg" class="img-responsive" alt=""
                  /></a>
                </li>
                <li><span class="name">Analog Watches</span></li>
              ...
              <ul class="cart-header2">
                ...
                <li class="ring-in">
                  <a href="single.php"
                    ><img src="images/c-3.jpg" class="img-responsive" alt=""
                  /></a>
                </li>
                <li><span class="name">Analog Watches</span></li>
