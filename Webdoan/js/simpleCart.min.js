    ...
    C = function (q) {
                  ...
                  k(a, s)
                    ? a.match(/<=.*/)
                      ? ((a = parseFloat(a.replace("<=", ""))),
                        (c.get(d) && parseFloat(c.get(d)) <= a) || (g = !1))
                      : a.match(/</)
                      ? ((a = parseFloat(a.replace("<", ""))),
                        (c.get(d) && parseFloat(c.get(d)) < a) || (g = !1))
                      : a.match(/>=/)
        ...
        ready: function (a) {
          h(a)
            ? b.isReady
              ? a.call(b)
              : b.bind("ready", a)
            : e(a) && !b.isReady && (b.trigger("ready"), (b.isReady = !0));
        },
        error: function (a) {
          var d = "";
          k(a, s)
            ? (d = a)
            : k(a, "object") && k(a.message, s) && (d = a.message);
          try {
      ...
      b.extend({
        tax: function () {
          ...
          b.each(function (a) {
            a.get("tax")
              ? (d += a.get("tax"))
              : a.get("taxRate") && (d += a.get("taxRate") * a.total());
          });
          return parseFloat(d);
        },
        taxRate: function () {
        ...
        shipping: function (a) {
          if (h(a)) b({ shippingCustom: a });
            ...
            var d =
              m.shippingQuantityRate * b.quantity() +
              m.shippingTotalRate * b.total() +
              m.shippingFlatRate;
      ...
      b.extend({
        writeCart: function (a) {
          ...
          for (h = m.cartColumns.length; c < h; c += 1)
            (f = E(m.cartColumns[c])),
              (a =
                "item-" +
                (f.attr || f.view || f.label || f.text || "cell") +
                " " +
                f.className),
              (f = f.label || ""),
              d.append(b.$create(u).addClass(a).php(f));
          b.each(function (a, d) {
        ...
        createCartRow: function (a, d, c, g, u) {
          d = b
            .$create(c)
            .addClass("itemRow row-" + d + " " + (d % 2 ? "even" : "odd"))
            .attr("id", "cartItem_" + a.id());
          var e, f, l;
          u.append(d);
          u = 0;
          for (c = m.cartColumns.length; u < c; u += 1)
            (e = E(m.cartColumns[u])),
              (f =
                "item-" +
                (e.attr ||
                  (k(e.view, s) ? e.view : e.label || e.text || "cell")) +
                " " +
                e.className),
              (l = a),
              (l = (
                h(e.view)
                  ? e.view
                  : k(e.view, s) && h(B[e.view])
                  ? B[e.view]
                  : B.attr
              ).call(b, l, e)),
              (f = b.$create(g).addClass(f).php(l)),
              d.append(f);
          return d;
        },
      });
      b.Item = function (a) {
        function d() {
          ...
          k(c.quantity, s) &&
            (c.quantity = parseInt(
              c.quantity.replace(b.currency().delimiter, ""),
              10
            ));
        ...
        g.set = function (a, b) {
          e(a) ||
            ((c[a.toLowerCase()] = b),
            ("price" !== a.toLowerCase() && "quantity" !== a.toLowerCase()) ||
              d());
          return g;
        };
        g.equals = function (a) {
      ...
      b.Item._ = b.Item.prototype = {
        ...
        quantity: function (a) {
          return e(a)
            ? parseInt(this.get("quantity", !0) || 1, 10)
            : this.set("quantity", a);
        },
        price: function (a) {
          return e(a)
            ? parseFloat(
                this.get("price", !0)
                  .toString()
                  .replace(b.currency().symbol, "")
                  .replace(b.currency().delimiter, "") || 1
              )
            : this.set(
                "price",
                parseFloat(
      ...
      b.extend({
        checkout: function () {
          if ("custom" === m.checkout.type.toLowerCase() && h(m.checkout.fn))
            ...
            a.data &&
              a.action &&
              a.method &&
              !1 !== b.trigger("beforeCheckout", [a.data]) &&
              b.generateAndSendForm(a);
        ...
        generateAndSendForm: function (a) {
          ...
          b.each(a.data, function (a, g, e) {
            d.append(
              b.$create("input").attr("type", "hidden").attr("name", e).val(a)
            );
          });
          b.$("body").append(d);
          d.el.submit();
      ...
      b.extendCheckout({
        ...
        AmazonPayments: function (a) {
          ...
          b.each(function (c, g) {
            ...
            m.shippingQuantityRate &&
              (d["shipping_method_price_per_unit_rate_" + e] =
                m.shippingQuantityRate);
      ...
      b.extend(z, {
        MooTools: {
          ...
          live: function (a, d) {
            var c = this.selector;
            h(d) &&
              b.$("body").el.addEvent(a + ":relay(" + c + ")", function (a, b) {
                d.call(b, a);
              });
          },
          match: function (a) {
      ...
      b.ready(function () {
        ...
        b.bindInputs([
          ...
          },
          {
            ...
            callback: function () {
              b.find(
                b.$(this).closest(".itemRow").attr("id").split("_")[1]
              ).increment();
              b.update();
            },
          },
            ...
            callback: function () {
              ...
              b.each(c, function (c) {
                c.match(/item-.+/i) &&
                  ((c = c.split("-")[1]),
                  b
                    .find(d.closest(".itemRow").attr("id").split("_")[1])
                    .set(c, a.val()),
                  b.update());
              });
            },
          },
          {
            ...
            callback: function () {
              var a = {};
              b.$(this)
                .closest("." + x + "_shelfItem")
                .descendants()
                .each(function (d, c) {
                  var e = b.$(c);
                  e.attr("class") &&
                    e.attr("class").match(/item_.+/) &&
                    !e.attr("class").match(/item_add/) &&
                      ...
                      if (b.match(/item_.+/)) {
                        ...
                        switch (e.tag().toLowerCase()) {
                          ...
                          case "select":
                            ...
                            if (
                              !d ||
                              (("checkbox" === d.toLowerCase() ||
                                "radio" === d.toLowerCase()) &&
                                e.attr("checked")) ||
                              "text" === d.toLowerCase() ||
                              "number" === d.toLowerCase()
                            )
                              c = e.val();
                            break;
                          case "img":
                        ...
                        null !== c &&
                          "" !== c &&
                          (a[b.toLowerCase()] = a[b.toLowerCase()]
                            ? a[b.toLowerCase()] + ", " + c
                            : c);
                      }
                    });
        ...
        : f.attachEvent &&
          (p.DOMContentLoaded = function () {
            "complete" === f.readyState &&
              (f.detachEvent("onreadystatechange", DOMContentLoaded), b.init());
          });
      (function () {
...
(function () {
  ...
  "function" !== typeof JSON.stringify &&
    (JSON.stringify = function (e, f, k) {
      var n;
      y = h = "";
      if ("number" === typeof k) for (n = 0; n < k; n += 1) y += " ";
      else "string" === typeof k && (y = k);
      if (
        (q = f) &&
        "function" !== typeof f &&
        ("object" !== typeof f || "number" !== typeof f.length)
      )
        throw Error("JSON.stringify");
      return s("", { "": e });
    });
  "function" !== typeof JSON.parse &&
    (JSON.parse = function (e, f) {
      function h(e, k) {
        var n,
          p,
          l = e[k];
        if (l && "object" === typeof l)
          for (n in l)
            Object.prototype.hasOwnProperty.call(l, n) &&
              ((p = h(l, n)), void 0 !== p ? (l[n] = p) : delete l[n]);
        return f.call(e, k, l);
      }
      var n;
      e = String(e);
      ...
      if (f.addBehavior) {
        ...
        var s = (this.localStorage = {
            ...
            clear: function () {
              ...
              for (
                var e = 0;
                (attr = f.XMLDocument.documentElement.attributes[e++]);
